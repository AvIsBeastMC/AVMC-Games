...
<head>
    ...
    <script data-ad-client="ca-pub-9136061489722919" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        ...
        $(document).ready(() => {
            $.getJSON("https://api.mcsrvstat.us/1/" + url, (status) => {
                if (status.debug.ping) {
                    ...
                    $("#fors").append("Online " + "(" + status.players.online + "/" + "100" + ")");
                } else {
